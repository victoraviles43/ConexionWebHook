...
public partial class TbEntregaFlujoSe
{
    public int LngIdEntraga { get; set; }
    ...
    public int? DblNoInt { get; set; }

    public int? DblExt { get; set; }

    public string? TxtColonia { get; set; }

    public int? DblCp { get; set; }

    public string? TxtBanco { get; set; }

    public string? TxtCuentaBancaria { get; set; }

    public string? TxtSpei { get; set; }
}
