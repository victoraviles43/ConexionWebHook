...
public partial class TbProductoAte
{
    public int LngIdProductoAte { get; set; }
    ...
    public bool? BolCtsimple { get; set; }
    ...
    public bool? BolAefacturacion { get; set; }
    ...
    public decimal? DblCconHonorarios { get; set; }
